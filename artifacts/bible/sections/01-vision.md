...
A personal, self-hosted engineering harness, **K** — a single entry point for directing AI agents to perform real engineering work across a fleet of projects: managing tickets and goals, contributing code through GitHub pull requests, running automated skills and verification workflows, and making all of it visible through a high-clarity dashboard.
