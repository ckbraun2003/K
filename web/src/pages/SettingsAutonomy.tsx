  ...
  return (
    <div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-[var(--glass-tier-border)] bg-[var(--glass-2)] p-4">
      ...
      {errorMsg && (
        <p
          ...
          className="mt-2 rounded-lg border border-[var(--red)]/40 bg-red/10 px-3 py-2 text-[11px] text-[var(--red)]"
        >
          {errorMsg}
        </p>
      )}
