...
export default function ActivityStrip() {
  ...
  return (
    <footer className="relative z-10 flex items-center gap-5 overflow-x-auto whitespace-nowrap border-t border-[var(--border)] bg-[var(--surface)]/60 px-4 py-1.5 text-xs backdrop-blur">
      {active.length === 0 && (
