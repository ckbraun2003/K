...
<div class="deck" id="deck">
  <aside>
    ...
    <nav class="nav" id="nav">
      ...
      <button data-action="route" data-arg="org"><svg class="gi"><use href="#i-crown"></use></svg><span class="lbl">Org</span></button>
      <button data-action="route" data-arg="projects"><svg class="gi"><use href="#i-grid"></use></svg><span class="lbl">Projects</span></button>
      <button data-action="route" data-arg="skills"><svg class="gi"><use href="#i-idea"></use></svg><span class="lbl">Skills</span></button>
      ...
      <button data-action="route" data-arg="inbox"><svg class="gi"><use href="#i-alert"></use></svg><span class="lbl">Inbox</span><span class="badge">3</span></button>
    </nav>
  ...
  <main id="main">
    ...
    <section class="screen" data-view="chief">
      <div class="rowhead"><h1 class="page">Org · Tree</h1>
        <span class="seg"><button data-action="route" data-arg="org">Roster</button><button class="active" data-action="route" data-arg="chief">Tree</button><button data-action="toast" data-msg="Fleet graph — force-directed org view" data-variant="info">Graph</button></span>
    ...
    <!-- ============ ORCHESTRATORS ============ -->
    <section class="screen" data-view="org">
      <div class="rowhead"><h1 class="page">Org</h1><span class="seg"><button class="active" data-action="route" data-arg="org">Roster</button><button data-action="route" data-arg="chief">Tree</button><button data-action="toast" data-msg="Fleet graph — force-directed org view" data-variant="info">Graph</button></span><span class="muted">· 5 leads · 3 active</span>
        <div class="right">
...
tests, contract drift, or unhandled errors. Return a verdict + reasons.</textarea>
    ...
    <!-- ============ SKILLS ============ -->
    <section class="screen" data-view="skills">
      <div class="rowhead"><h1 class="page">Skills</h1>
        ...
        <div class="right"><button class="btn primary" data-action="route" data-arg="k-home"><svg class="gi"><use href="#i-plus"></use></svg> new skill</button></div></div>

      <div data-tabpanel="sk" data-arg="skills" class="tabpanel active">
        <div class="grid3 cards">
      ...
      <div data-tabpanel="sk" data-arg="automations" class="tabpanel">
    ...
    <!-- ============ INBOX ============ -->
    <section class="screen" data-view="inbox">
      ...
      <div class="panel">
        <div class="list stack">
          ...
          <div class="row"><span class="tier-chip sec">Security</span><span class="grow">API surface audit blocked — needs your decision</span><span class="pill error"><span class="d"></span>needs you</span><button class="btn sky sm" data-action="route" data-arg="chief">Open</button></div>
...
This is the shared system prompt for every agent the harness runs.</textarea>
  ...
  <div class="strip">
    ...
    <span class="right">
      ...
      <span class="muted">day totals in <a class="link" data-action="route" data-arg="insights">Insights →</a></span>
...
<script>
  (function () {
    ...
    var meta = {
      ...
      'org':           { nav: 'org', title: 'Org', icon: 'i-crown', crumb: '' },
      'chief':         { nav: 'org', title: 'Org · Tree', icon: 'i-crown', crumb: 'Org › Tree' },
      'orchestrator-detail': { nav: 'org', title: 'Frontend Lead', icon: 'i-net', crumb: 'Org › Roster › Frontend Lead' },
      'workflows':     { nav: 'runs', title: 'Workflows', icon: 'i-flow', crumb: 'Runs › Workflows' },
      'workflow-detail': { nav: 'runs', title: 'Code wave', icon: 'i-flow', crumb: 'Runs › Workflows › Code wave' },
      ...
      'skills':        { nav: 'skills', title: 'Skills', icon: 'i-idea', crumb: '' },
      ...
      'inbox':         { nav: 'inbox', title: 'Inbox', icon: 'i-alert', crumb: '' },
      'terminal':      { nav: 'settings', title: 'Settings · Terminal', icon: 'i-term', crumb: 'Settings › Terminal' },
