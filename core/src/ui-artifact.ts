...
const UI_DEMO_SOURCE =
  ...
  'A self-contained, offline mock of the redesigned K dashboard — the 6-tab ' +
  '"you direct an organization" surface (Home chat/overview, Personal, ' +
  'Agents, Runs, Insights, Projects, Help, Settings) with the Message Dock, ' +
  'in-memory navigation and every key control present. Switch to the ' +
  '**.html** view to interact.'
...
<style>
  *, *::before, *::after { box-sizing: border-box; }
  ...
  @media (max-width: 720px) {
    ...
    aside { display: none; }
    .topbar, main, .dockbar { grid-column: 1; }
...
<div class="deck" id="deck">
  ...
  <main id="main">
    ...
    <!-- ============ K HOME ============ -->
    <section class="screen" data-view="home-chat">
      <div class="rowhead">
        <span class="seg" role="tablist">
          <button class="active" data-action="route" data-arg="home-chat">Chat</button>
          <button data-action="route" data-arg="home-overview">Overview</button>
        </span>
      </div>
      <div class="panel fill" style="display:flex;flex-direction:column;gap:.7rem">
        <div class="witem"><div class="witem-top"><span class="grow"><b>You</b> · refactor the auth module to use the new session store</span><span class="meta">09:14</span></div></div>
        <div class="witem"><div class="witem-top"><span class="grow"><b>K</b> · Routed to Chief → Backend Lead. Backend is drafting a plan now — I'll ping you when it needs a decision.</span><span class="meta">09:14</span></div>
          <div class="adv"><a class="link" data-action="route" data-arg="runs">View run →</a></div></div>
        <div class="witem"><div class="witem-top"><span class="grow"><b>You</b> · what's blocking the security audit?</span><span class="meta">09:31</span></div></div>
        <div class="witem"><div class="witem-top"><span class="grow"><b>K</b> · Security Lead flagged the public API surface — it needs your sign-off before it can continue.</span><span class="meta">09:31</span></div>
          <div class="adv"><a class="link" data-action="route" data-arg="personal">Open Personal →</a></div></div>
      </div>
    </section>

    <!-- ============ HOME OVERVIEW ============ -->
    <section class="screen" data-view="home-overview">
      <div class="rowhead">
        <span class="seg" role="tablist">
          <button data-action="route" data-arg="home-chat">Chat</button>
    ...
    <section class="screen" data-view="agents">
      ...
      <div class="grid2 cards" style="margin-bottom:.8rem">
        <button class="card lift" style="text-align:left;cursor:pointer;background:var(--surface);border:1px solid var(--border)" data-action="route" data-arg="home-chat">
          <div class="kv"><svg class="gi"><use href="#i-bolt"></use></svg><b>K</b></div>
          <p class="muted" style="margin:.3rem 0 0">Secretary — your front door. Chat lives on Home.</p>
        </button>
        <button class="card lift" style="text-align:left;cursor:pointer;background:var(--surface);border:1px solid var(--border)" data-action="tab" data-group="agorg" data-arg="tree">
          <div class="kv"><svg class="gi"><use href="#i-crown"></use></svg><b>Chief</b></div>
          <p class="muted" style="margin:.3rem 0 0">Manager — objectives &amp; delegation. See the Tree view.</p>
        </button>
      </div>
      ...
      <div class="rowhead"><h1 class="page">Org · Tree</h1>
        ...
        <div class="right" style="font-size:.78rem"><span class="muted">health</span><span class="bar watch" style="width:120px"><span style="width:78%"></span></span><span class="mono">78/100</span><span class="pill watch"><span class="d"></span>watch</span>
          ...
          <a class="link" data-action="route" data-arg="insights">Insights →</a>
      ...
      <div data-tabpanel="ag" data-arg="skills">
        ...
        <div data-tabpanel="sk" data-arg="skills" class="active">
          <div class="grid3 cards">
            <div class="card lift panel" style="margin:0"><div class="kv"><svg class="gi"><use href="#i-idea"></use></svg><b>create-mobile-ui-artifact</b></div><p class="muted" style="margin:.3rem 0;font-size:.8rem">Author a self-contained mobile monitor+approve mock.</p><div class="kv"><span class="pill done"><span class="d"></span>ready</span><a class="link" data-action="route" data-arg="runs">last run →</a></div></div>
            <div class="card lift panel" style="margin:0"><div class="kv"><svg class="gi"><use href="#i-idea"></use></svg><b>regenerate-artifacts</b></div><p class="muted" style="margin:.3rem 0;font-size:.8rem">Recompile demo + bible from their real sources.</p><div class="kv"><span class="pill done"><span class="d"></span>ready</span><a class="link" data-action="route" data-arg="runs">last run →</a></div></div>
            <div class="card lift panel" style="margin:0"><div class="kv"><svg class="gi"><use href="#i-idea"></use></svg><b>verify-artifacts-screenshot</b></div><p class="muted" style="margin:.3rem 0;font-size:.8rem">Headless-Edge screenshot check for HTML artifacts.</p><div class="kv"><span class="pill running"><span class="d"></span>running</span><a class="link" data-action="route" data-arg="runs">live run →</a></div></div>
          </div>
        </div>
        <div data-tabpanel="sk" data-arg="automations">
          <div class="panel"><h2>Automations <span class="right muted">routines · scheduled + event triggers</span></h2>
            <div class="row muted mono" style="font-size:.66rem;letter-spacing:.04em;padding:0 .1rem .2rem"><span class="grow">routine</span><span style="width:150px">next run</span><span style="width:64px;text-align:right">cost 30d</span><span style="width:64px;text-align:right">state</span></div>
            <div class="list stack" style="font-size:.84rem">
              <div class="row"><span class="grow">Nightly verify sweep <span class="muted">· cron 02:00</span></span><span class="mono muted" style="width:150px;font-size:.74rem">in 6h 12m · 02:00</span><span class="mono" style="width:64px;text-align:right">$2.14</span><span style="width:64px;text-align:right"><span class="pill done"><span class="d"></span>on</span></span></div>
              <div class="row"><span class="grow">Weekly bible freshness <span class="muted">· cron Mon 09:00</span></span><span class="mono muted" style="width:150px;font-size:.74rem">in 3d · Mon 09:00</span><span class="mono" style="width:64px;text-align:right">$0.38</span><span style="width:64px;text-align:right"><span class="pill done"><span class="d"></span>on</span></span></div>
              <div class="row"><span class="grow">On PR opened → security review <span class="muted">· event</span></span><span class="mono muted" style="width:150px;font-size:.74rem">on event</span><span class="mono" style="width:64px;text-align:right">$1.02</span><span style="width:64px;text-align:right"><span class="pill queued"><span class="d"></span>paused</span></span></div>
            </div>
            <div class="adv" style="margin-top:.7rem"><span class="muted">Schedule in plain English:</span>
              <input style="flex:1;min-width:150px;background:var(--raised);border:1px solid var(--border);border-radius:8px;color:var(--text);font:inherit;font-size:.74rem;padding:.22rem .5rem" placeholder="e.g. every weekday at 7am" aria-label="Describe a schedule" />
              <button class="btn secondary sm" data-action="toast" data-msg="Parsed → cron 0 7 * * 1-5 (rules-only, no model — an unmappable phrase is rejected)" data-variant="info">→ cron</button></div>
          </div>
        </div>
      </div>
      ...
      <div data-tabpanel="ag" data-arg="pipelines">
        ...
        <div class="split">
          ...
          <div class="panel col"><h2>Role graph <span class="right muted">Code wave</span></h2>
            <p class="muted" style="font-size:.74rem;margin:-.2rem 0 .8rem">4 roles · sequential · tier T1 · used by <span class="fe">Frontend</span>, <span class="be">Backend</span> · 42 runs</p>
            ...
            <div class="kv" style="justify-content:center;margin-top:.9rem;gap:.4rem">
              ...
              <button class="btn primary sm" data-action="confirm" data-title="Run this workflow?" data-body="Run the Code-wave workflow now?" data-confirm="Run" data-toast-msg="Code-wave dispatched" data-toast-link="1"><svg class="gi"><use href="#i-bolt"></use></svg> run this workflow</button>
            </div>

            <div class="panel" style="margin-top:1rem;background:var(--bg-deep)">
...
- Hand security-sensitive changes to the Security lead via Chief.</textarea>
      ...
      <div data-tabpanel="pz" data-arg="tasks">
        ...
        <div class="panel">
          ...
          <div class="witem"><div class="witem-top"><span class="check" data-action="toggle-check"><span class="box"></span></span><span class="grow">verify core</span><span class="pill queued"><span class="d"></span>queued</span></div>
            <div class="adv"><a class="link" data-action="toast" data-msg="Promoted to an org objective — see Agents" data-variant="info">promote to objective →</a></div></div>
          <button class="btn ghost sm" style="margin-top:.5rem" data-action="toast" data-msg="Inline task composer opened" data-variant="info"><svg class="gi"><use href="#i-plus"></use></svg> add task</button>
        </div>
      </div>
      ...
      <div data-tabpanel="pz" data-arg="chats">
        ...
        <div class="panel">
          <div class="list">
            ...
            <div class="row selrow" data-action="select-row"><span class="grow"><b>Weekly planning</b><br><span class="muted" style="font-size:.72rem">last: 3 objectives drafted</span></span><span class="meta">1d</span></div>
          </div>
          <button class="btn ghost sm" style="margin-top:.5rem" data-action="route" data-arg="home-chat"><svg class="gi"><use href="#i-plus"></use></svg> new chat</button>
        </div>
      </div>
      ...
      <div data-tabpanel="pz" data-arg="memories">
        ...
        <div class="panel">
          <div class="list stack" style="font-size:.84rem">
            ...
            <div class="row"><span class="grow">timezone: America/Denver</span><button class="btn ghost sm" data-action="confirm" data-title="Forget this?" data-body="Remove this memory?" data-variant="danger" data-confirm="Forget" data-toast-msg="Memory removed" data-toast-variant="info"><svg class="gi"><use href="#i-trash"></use></svg></button></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="screen" data-view="insights">
      ...
      <div class="mgrid">
        ...
        <div class="card mcard"><h2>Budget burn-down <span class="right muted">24h · measured</span></h2>
          <svg class="chart" viewBox="0 0 300 130" aria-label="budget burn-down measured 24h">
            <line class="axis" x1="28" y1="110" x2="290" y2="110"/>
            <line x1="28" y1="24" x2="290" y2="24" stroke="#f87171" stroke-width="1.5" stroke-dasharray="4 3"/>
            <text class="axlabel" x="286" y="20" text-anchor="end" fill="#f87171">cap $25</text>
            <line x1="28" y1="41" x2="290" y2="41" stroke="#fbbf24" stroke-width="1" stroke-dasharray="3 3" opacity=".7"/>
            <text class="axlabel" x="286" y="52" text-anchor="end" fill="#fbbf24">warn 80%</text>
            <polygon fill="#ff8fc0" fill-opacity=".14" points="28,110 56,102 84,92 112,84 140,72 168,66 196,58 224,52 252,48 290,44 290,110"/>
            <polyline fill="none" stroke="#ff8fc0" stroke-width="2" points="28,110 56,102 84,92 112,84 140,72 168,66 196,58 224,52 252,48 290,44"/>
          </svg>
          <div class="legend"><span class="lk"><span class="sw" style="background:#ff8fc0"></span>spent $18.40</span><span class="lk mono muted">measured — no forecast</span></div>
        </div>

        <div class="card mcard"><h2>Retry rate <span class="right muted">14d · self-heal</span></h2>
          <svg class="chart" viewBox="0 0 300 130" aria-label="retry rate 14d">
            <line class="gridline" x1="28" y1="44" x2="296" y2="44"/><line class="gridline" x1="28" y1="77" x2="296" y2="77"/>
            <line class="axis" x1="28" y1="110" x2="296" y2="110"/>
            <text class="axlabel" x="24" y="20" text-anchor="end">10%</text><text class="axlabel" x="24" y="114" text-anchor="end">0</text>
            <g fill="#38bdf8" fill-opacity=".8">
              <rect x="30" y="98" width="13" height="12" rx="2"/><rect x="50" y="92" width="13" height="18" rx="2"/>
              <rect x="70" y="104" width="13" height="6" rx="2"/><rect x="90" y="86" width="13" height="24" rx="2"/>
              <rect x="110" y="96" width="13" height="14" rx="2"/><rect x="130" y="80" width="13" height="30" rx="2"/>
              <rect x="150" y="100" width="13" height="10" rx="2"/><rect x="170" y="90" width="13" height="20" rx="2"/>
              <rect x="190" y="104" width="13" height="6" rx="2"/><rect x="210" y="94" width="13" height="16" rx="2"/>
              <rect x="230" y="84" width="13" height="26" rx="2"/><rect x="250" y="98" width="13" height="12" rx="2"/>
              <rect x="270" y="102" width="13" height="8" rx="2"/>
            </g>
          </svg>
          <div class="legend"><span class="lk mono">3.1% retried</span><span class="lk mono muted">off runs.retry_of</span></div>
        </div>
      </div>
    </section>
    ...
    <section class="screen" data-view="settings">
      ...
      <div class="panel"><h2>Autonomous Org <span class="right muted">default OFF · one front door</span></h2>
        <div class="list" style="font-size:.82rem">
          <div class="row"><span class="grow"><b>Autonomous Org</b> <span class="muted" style="font-size:.72rem">— gates the whole stack</span></span><span class="toggle on" data-action="toast" data-msg="Autonomous Org enabled — applies at runtime, no restart" data-variant="info"></span></div>
          <div class="row"><span class="grow">Generate proposals <span class="muted" style="font-size:.72rem">· CI / verify / issues / bible</span></span><span class="toggle on" data-action="toast" data-msg="Proposal collectors on" data-variant="info"></span></div>
          <div class="row"><span class="grow">Auto-pull backlog</span><span class="toggle" data-action="toast" data-msg="Backlog auto-pull off" data-variant="info"></span></div>
          <div class="row"><span class="grow">Self-heal failed runs</span><span class="toggle on" data-action="toast" data-msg="Self-heal on" data-variant="info"></span></div>
        </div>
        <div class="kv" style="margin-top:.7rem;gap:1.1rem;flex-wrap:wrap;font-size:.8rem">
          <span class="kv" style="gap:.4rem"><span class="muted">max concurrency</span><span class="tier-chip mono">2</span></span>
          <span class="kv" style="gap:.4rem"><span class="muted">org daily cap</span><span class="tier-chip mono">$25.00</span></span>
          <span class="kv" style="gap:.4rem"><span class="muted">warn at</span><span class="tier-chip mono">80%</span></span>
        </div>
        <div class="banner" style="margin-top:.7rem"><svg class="gi"><use href="#i-info"></use></svg> The budget cap is an always-on safety limit — it applies to manual and autonomous dispatches even while the master is off, once set.</div>
      </div>
...
This is the shared system prompt for every agent the harness runs.</textarea>
      ...
      <div class="panel"><h2>Terminal</h2>
        <div class="right" style="margin:-.3rem 0 .6rem"><button class="btn secondary sm" data-action="confirm" data-title="Enable terminal?" data-body="Set ENABLE_TERMINAL=true and start an embedded shell at the project root?" data-confirm="Enable" data-toast-msg="Terminal enabling…" data-toast-variant="info"><svg class="gi"><use href="#i-term"></use></svg> Enable terminal</button></div>
        ...
        <div class="term">$ <span class="caret-blink">_</span></div>
      </div>
    </section>
      ...
      <div class="split balance">
        <div class="panel"><h2>Contents</h2>
          ...
          <div class="list mono" style="font-size:.74rem">
            ...
            <div class="row"><span class="grow">Go: Home / Personal / Agents</span><span class="meta">g h / g u / g a</span></div>
            <div class="row"><span class="grow">Runs / Insights / Projects</span><span class="meta">g r / g n / g p</span></div>
...
<button class="dock-fab" id="dockFab" data-action="dock-open" aria-label="Message K" title="Message K">K<span class="badge">3</span></button>
...
<div class="overlay" id="dock">
  ...
  <div class="dock-wrap"><div class="dockcard glass-strong">
    <div class="dock-threads">
      ...
      <div class="dock-thread-row" data-action="select-row">Weekly planning</div>
    </div>
    <div class="dock-compose">
      <div class="kv muted" style="font-size:.72rem;justify-content:space-between">
        <span>→ Auth refactor plan</span>
        <button class="link" style="background:none;border:none;cursor:pointer" data-action="toast" data-msg="New chat thread started" data-variant="info">+ New chat</button>
      </div>
      <div class="dock-input">
        <svg class="gi"><use href="#i-bolt"></use></svg>
        <input id="dockInput" placeholder="Message K…" aria-label="Message K" />
        <button class="micbtn" data-action="toast" data-msg="Listening… hold to talk, release to send" data-variant="info" title="Hold to talk (Alt Space)" aria-label="Hold to talk"><svg class="gi"><use href="#i-mic"></use></svg></button>
      </div>
...
<script>
  (function () {
    ...
    function route(view) {
      ...
      // Message Dock (D-102): bar variant on Home, floating fab everywhere else
      // (never on the login screen). One front door either way — Ctrl K always
      // opens the full #dock overlay regardless of which variant is showing.
      var showBar = (view === 'home-chat' || view === 'home-overview');
      var showFab = !showBar && view !== 'login';
      if (dk) dk.classList.toggle('no-dockbar', !showBar);
      var db = $('#dockbar'); if (db) db.classList.toggle('show', showBar);
      var df = $('#dockFab'); if (df) df.classList.toggle('show', showFab);
    }

    function open(sel) { $(sel).classList.add('show'); }
    function close(sel) { $(sel).classList.remove('show'); }

    // The Message Dock overlay is the ONE front door alongside the persistent
    // dockbar/fab. A per-screen ⚡ opens it pre-scoped with the route shown.
    function openDock() {
      open('#dock');
      renderRoute('');
      var i = $('#dockInput'); if (i) { i.value = ''; setTimeout(function () { i.focus(); }, 20); }
    }
    function openDockScoped(q, scope) {
      open('#dock');
      renderRoute(scope || '');
      var i = $('#dockInput'); if (i) { i.value = q || ''; setTimeout(function () { i.focus(); }, 20); }
    }
    function renderRoute(scope) {
      var rl = $('#dockRoute'); if (!rl) return;
    ...
    function dispatchSend(rt) {
      var r = rt;
      if (!r) { var rl = $('#dockRoute'); r = rl ? rl.textContent.replace(/^routes\s*/, '').trim() : '→ Chief'; }
      close('#dock'); route('runs'); toast('Dispatched · ' + r, 'success', '', true);
    }
    ...
    document.addEventListener('click', function (e) {
      ...
      if (a === 'dock-open') { openDock(); return; }
      if (a === 'dock-close') { close('#dock'); return; }
      if (a === 'cmd-dispatch') { openDockScoped(t.dataset.q || '', t.dataset.scope || ''); return; }
    ...
    document.addEventListener('keydown', function (e) {
      if ((e.metaKey || e.ctrlKey) && (e.key === 'k' || e.key === 'K')) { e.preventDefault(); openDock(); return; }
      if (e.key === 'Escape') {
        ['#confirm', '#dock'].some(function (s) {
