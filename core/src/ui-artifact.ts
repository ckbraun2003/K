    ...
    <section class="screen" data-view="agents">
      ...
      <div data-tabpanel="ag" data-arg="skills">
        ...
        <div data-tabpanel="sk" data-arg="automations">
          <div class="panel"><h2>Automations <span class="right muted">scheduled + event triggers</span></h2>
            <div class="list stack" style="font-size:.84rem">
              <div class="row"><span class="grow">Nightly verify sweep <span class="muted">· cron 02:00</span></span><span class="pill done"><span class="d"></span>enabled</span></div>
              <div class="row"><span class="grow">On PR opened → security review <span class="muted">· event</span></span><span class="pill queued"><span class="d"></span>paused</span></div>
            </div>
          </div>
        </div>
      </div>
...
- Hand security-sensitive changes to the Security lead via Chief.</textarea>
    ...
    <section class="screen" data-view="personal">
      ...
      <div data-tabpanel="pz" data-arg="inbox" class="active">
        <div class="rowhead"><h1 class="page text-display">Inbox</h1><span class="muted">· union over plan / review / verify / approvals — never a table</span>
          <div class="right"><span class="pill watch"><span class="d"></span>3 pending</span></div></div>
