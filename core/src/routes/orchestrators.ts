...
export async function orchestratorsRoutes(app: FastifyInstance) {
  ...
  // PATCH /api/orchestrators/:id — edit a lead's authority (charter/tier/skills/tools/
  // mcp/model). Validate the patch (400), confirm the target is a lead (404), then let
